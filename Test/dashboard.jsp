...
<div class="container">
    <div class="jumbotron">
        ...
        <button type="button" class="btn btn-primary" onclick="location.href='rewindingdashboard.jsp'">Rewinding
            Details</button>
        ...
        <button type="button" class="btn btn-primary" onclick="location.href='home.html'">Logout</button>
    </div>
</div>
</body>
